        ...
        <div className={styles.diagram_wrapper}>
            ...
            <div className={styles.levels_wrapper} >
                <div style={{
                    ...
                    transform: 'translateY(-50%)', zIndex: '100', position: 'relative'
                }}>
            ...
            <div style={{
                ...
                width: '85%', position: 'absolute', top: '0', right: '0',
                ...
                <div
                    style={{
                        position: 'absolute', left: '0', height: '110%', width: '1px',
                        opacity: 0.5,
                ...
                <div style={{
                    ...
                    height: '100%',
                    borderRadius: '8px 8px 0px 0px',
                    background: 'linear-gradient(180deg, #CC3629 0%, #CCCC29 49.84%, #29CC7A 100%)'
                }}>
